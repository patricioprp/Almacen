...
<div class="form-group">
        <div class="row">
            ...
            <div class="col-lg-2">
                {!! Form::text('id',$proveedor->id,['class' => 'form-control hidden', 'placeholder'=>'dd-mm-aaaa','required']) !!}
            </div>
            <div class="col-lg-2">
                ...
                <div id="dynamicDiv"> 
                 <div class="row">
                    <div class="col-lg-2">
                     ...
                     <div class="col-lg-2">
                        {!! Form::select('produstos[]', $productos,null,['class' => 'form-control select-productos','id'=>'productos', 'multiple', 'required']) !!}
                      </div>
                      <div class="col-lg-2">
